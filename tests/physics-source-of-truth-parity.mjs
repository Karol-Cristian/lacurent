...
assert.doesNotMatch(workerSource, /getPrimaryEnergyFactor/);
assert.doesNotMatch(workerSource, /getCo2Factor/);
assert.doesNotMatch(workerSource, /classifyEstimatedEnergyClassFromRegistry/);
assert.doesNotMatch(workerSource, /resolveMc001Carrier/);
assert.doesNotMatch(workerSource, /selectedDhwPresetV04/);
assert.doesNotMatch(workerSource, /finalEnergyCarrierByUse/);
assert.doesNotMatch(workerSource, /src\/physics-engine/);
assert.doesNotMatch(workerSource, /src\/features\/energy\/physics/);
