export type FormulaStatus =
  | "implemented_simplified"
  | "implemented_traceable"
...
export interface FormulaRegistryEntry {
  ...
  output: string;
  unit: string;
  source: "mc001_conceptual" | "internal_estimate" | "registry_default";
  status: FormulaStatus;
}

export const FORMULA_REGISTRY: Record<string, FormulaRegistryEntry> = {
  R_LAYER: {
    id: "R_LAYER",
