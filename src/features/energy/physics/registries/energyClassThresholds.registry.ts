...
export interface PrimaryEnergyClassThreshold {
  class: EstimatedEnergyClass;
  minKwhM2Year: number;
  maxKwhM2Year: number | null;
  source: "MC001-2022";
...
] as const satisfies readonly PrimaryEnergyClassThreshold[];
...
function toThresholdSet(
  id: string,
  buildingType: BuildingEnergyClassType,
  thresholds: readonly PrimaryEnergyClassThreshold[]
