"""P11C production-reachable execution-domain manifest.
    ...
    "chapters": {
        ...
        "chapter3": {
            "branches": [
                ...
                "heating_emission_temperature_increase",
                "heating_hydronic_pump_auxiliary",
                "heating_generator_loss_power_curve",
                "heating_generator_standby_coefficients",
                "heating_generator_auxiliary_power_curve",
                "heating_generator_auxiliary_coefficients",
                "cooling_single_system",
                "cooling_parallel_systems",
                "cooling_distribution_factor",
                "cooling_storage_thermal_losses",
                "cooling_storage_pump_auxiliary",
                "cooling_compression_generator_contract",
                "cooling_absorption_generator_contract",
                "cooling_capacity_supplied_unmet",
                "dhw_system",
                "dhw_distribution_loss_components",
                "dhw_recirculation_pump_auxiliary",
                "dhw_heat_tracing_auxiliary",
                "dhw_storage_standing_loss_single_volume",
                "ventilation_ahu_auxiliary",
                "ventilation_heat_recovery_auxiliary_contract",
                "ventilation_preheat_auxiliary_contract",
                "ventilation_control_auxiliary_contract",
                "ventilation_ahu_thermal_relations",
                ...
                "shared_generator_operation_time_calculation",
