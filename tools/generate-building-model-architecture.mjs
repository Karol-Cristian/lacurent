...
const domains = Object.freeze([
  ...
  },
  {
    ...
    lifecycle: "explicit user engineering input; persisted with Building DNA",
    responsibilities: [
...
const fields = [
  ...
  field({
    ...
    purpose: "Explicit Chapter 3 heating system stages, losses, auxiliaries and recovered fractions.",
    category: "primitive_user_input",
    ...
    dataType: "system stage array, kWh/month and fractions",
    editable: true,
    productionUsage: "drives_Chapter3_heating_system_energy",
  ...
  field({
    ...
    purpose: "Explicit Chapter 3 cooling system stages, losses, auxiliaries and recovered fractions.",
    category: "primitive_user_input",
    owner: "User through Technical Systems schema",
    ...
    dataType: "system stage array, kWh/month and fractions",
    editable: true,
    productionUsage: "drives_Chapter3_cooling_system_energy",
  ...
  field({
    ...
    purpose: "Explicit DHW useful demand and system-stage inputs.",
    category: "primitive_user_input",
    owner: "User through Technical Systems schema",
    sourceOfTruth: "buildingDna.technicalSystems.domesticHotWater",
    producer: "buildTechnicalSystemsFromForm",
    consumer: "buildChapter3RuntimeInputFromBuildingDna",
    dataType: "kWh/month and stage array",
    editable: true,
