...
def _pairwise_interaction_probes(
    ...
    *,
    ...
    """Probe bounded pairwise interactions among the strongest isolated measures.

    The former worker-safe search learned mostly from one-dimensional probes.
    This adds at most six 50%+50% interaction candidates from the best four
    isolated dimensions, capturing important combinations without returning to
    a combinatorial or monolithic Worker request.
    """
