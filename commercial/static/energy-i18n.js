(() => {
  ...
  const RO_EN = {
    ...
    "Pereți exteriori (m²)":"Exterior walls (m²)","Coeficient U pereți":"Wall U-value","Acoperiș / tavan (m²)":"Roof / ceiling (m²)","Coeficient U acoperiș":"Roof U-value","Pardoseală spre sol / spațiu rece (m²)":"Floor to ground / cold space (m²)","Coeficient U pardoseală":"Floor U-value","Ferestre (m²)":"Windows (m²)","Coeficient U ferestre":"Window U-value","Uși exterioare (m²)":"Exterior doors (m²)","Coeficient U uși":"Door U-value","Lungime punți termice (m)":"Thermal-bridge length (m)","Transmitanță liniară ψ":"Linear transmittance ψ","Aport solar explicit":"Explicit solar gains",
    "Ventilația":"Ventilation","Alege tipul de ventilare. Debitul de aer și recuperarea se deduc intern.":"Choose the ventilation type. Airflow and heat recovery are derived internally.","Ventilație naturală":"Natural ventilation","Ventilație mecanică":"Mechanical ventilation","Ventilație cu recuperare":"Heat-recovery ventilation","Nu știu":"I don't know","Setări avansate — coeficienți de ventilare":"Advanced settings — ventilation coefficients","Schimburi de aer pe oră":"Air changes per hour","Eficiența recuperării de căldură":"Heat-recovery efficiency",
