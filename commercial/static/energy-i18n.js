(() => {
  ...
  const RO_EN = {
    ...
    "Pereți exteriori (m²)":"Exterior walls (m²)","Coeficient U pereți":"Wall U-value","Acoperiș / tavan (m²)":"Roof / ceiling (m²)","Coeficient U acoperiș":"Roof U-value","Pardoseală spre sol / spațiu rece (m²)":"Floor to ground / cold space (m²)","Coeficient U pardoseală":"Floor U-value","Ferestre (m²)":"Windows (m²)","Coeficient U ferestre":"Window U-value","Uși exterioare (m²)":"Exterior doors (m²)","Coeficient U uși":"Door U-value","Lungime punți termice (m)":"Thermal-bridge length (m)","Transmitanță liniară ψ":"Linear transmittance ψ","Aport solar explicit":"Explicit solar gains","Orientarea dominantă a ferestrelor":"Dominant window orientation","Tipul principal de vitraj":"Main glazing type","Sud":"South","Sud-Vest":"South-West","Vest":"West","Nord-Vest":"North-West","Nord":"North","Nord-Est":"North-East","Est":"East","Sud-Est":"South-East","Vitraj simplu":"Single glazing","Vitraj dublu":"Double glazing","Fereastră dublă":"Double window","Vitraj triplu":"Triple glazing","Vitraj dublu low-e":"Double low-e glazing","Vitraj triplu low-e":"Triple low-e glazing","Sud (m²)":"South (m²)","Sud-Vest (m²)":"South-West (m²)","Vest (m²)":"West (m²)","Nord-Vest (m²)":"North-West (m²)","Nord (m²)":"North (m²)","Nord-Est (m²)":"North-East (m²)","Est (m²)":"East (m²)","Sud-Est (m²)":"South-East (m²)","Storuri venetiene albe · τ 0,05":"White venetian blinds · τ 0.05","Storuri venetiene albe · τ 0,10":"White venetian blinds · τ 0.10","Storuri venetiene albe · τ 0,30":"White venetian blinds · τ 0.30","Perdele albe · τ 0,50":"White curtains · τ 0.50","Perdele albe · τ 0,70":"White curtains · τ 0.70","Perdele albe · τ 0,90":"White curtains · τ 0.90","Textile colorate · τ 0,10":"Coloured textiles · τ 0.10","Textile colorate · τ 0,30":"Coloured textiles · τ 0.30","Textile colorate · τ 0,50":"Coloured textiles · τ 0.50","Textile aluminizate · τ 0,05":"Aluminium-coated textiles · τ 0.05","În modul automat, aportul solar lunar folosește Hsol din Anexa A.9.6. Se folosește stația-sursă directă sau cea mai apropiată disponibilă; valorile Hsol nu sunt interpolate, iar sursa și distanța apar în raport.":"In automatic mode, monthly solar gains use Hsol from Annex A.9.6. The direct source station or the nearest available source is used; Hsol values are not interpolated, and the source and distance are shown in the report.","Ferestre pe orientări":"Windows by orientation","Dacă introduci aici suprafețe, suma lor trebuie să corespundă suprafeței totale a ferestrelor. Dacă le lași la 0, toate ferestrele folosesc orientarea dominantă selectată mai sus.":"If you enter areas here, their sum must match the total window area. If left at 0, all windows use the dominant orientation selected above.","Dispozitiv de umbrire MC001":"MC001 shading device","Poziția dispozitivului":"Device position","Fără dispozitiv selectat":"No device selected","Interior":"Interior","Exterior":"Exterior","Metodă aport solar":"Solar-gain method","Automat MC001 / Hsol A.9.6":"Automatic MC001 / A.9.6 Hsol","Aport lunar explicit":"Explicit monthly gain","Fracție ramă fereastră":"Window frame fraction","Factor umbrire obstacole":"Obstacle shading factor","Factor vedere către cer":"Sky-view factor","Rezistență superficială exterioară Rse":"Exterior surface resistance Rse","Coeficient radiație lungă spre cer":"Long-wave sky-radiation coefficient","Diferență temperatură cer":"Sky temperature difference",
    ...
    "Rezultatul calculului":"Calculation result","Clasa":"Class","Încadrare orientativă":"Indicative energy band","Estimare tehnică · nu este CPE":"Technical estimate · not a legal EPC","Energie primară":"Primary energy","Energie finală":"Final energy","energia cumpărată de la toate sursele":"energy purchased from all sources","Emisii CO₂":"CO₂ emissions","Coeficient total de pierdere":"Total heat-loss coefficient",
    "Cost anual estimat al energiei":"Estimated annual energy cost","Cost estimat al serviciilor energetice modelate":"Estimated cost of modelled energy services","Încălzire · răcire · apă caldă. Nu include consumul electric de bază al locuinței.":"Heating · cooling · hot water. Household base electricity is not included.","Calculat din energia finală cumpărată, după randamentul sau SCOP-ul instalației.":"Calculated from purchased final energy after system efficiency or SCOP.","Total anual estimat":"Estimated annual total","Total anual calculabil":"Annual priceable total","Medie lunară":"Monthly average","Vezi detaliile costului":"View cost details","Încălzire · răcire · apă caldă · fiecare lună":"Heating · cooling · hot water · every month","Deschide":"Open","Răcire":"Cooling","Preț local necesar":"Local price required","fără consum calculat":"no calculated consumption",
    "Referință de preț care necesită actualizare.":"Price reference requires an update.","Costul rămâne vizibil pentru comparație, dar nu trebuie tratat ca preț comercial curent.":"The cost remains visible for comparison but must not be treated as a current commercial price.","Expirată:":"Expired:","Încă neintrată în vigoare:":"Not yet effective:","Cost lunar estimat":"Estimated monthly cost","Încălzirea și răcirea urmează profilul lunar calculat; ACM se distribuie după numărul de zile din lună.":"Heating and cooling follow the calculated monthly profile; DHW is distributed by the number of days in each month.","Luna":"Month","ACM":"DHW","Total":"Total","Ianuarie":"January","Februarie":"February","Martie":"March","Aprilie":"April","Mai":"May","Iunie":"June","Iulie":"July","August":"August","Septembrie":"September","Octombrie":"October","Noiembrie":"November","Decembrie":"December","Prețurile folosite":"Prices used",
    "Energie finală pe utilizări":"Final energy by service","Valori anuale calculate din necesarul util și performanța instalațiilor.":"Annual values calculated from useful demand and system performance.","Comparație cu clădirea de referință":"Comparison with the reference building","Aceeași geometrie, parametri de referință, același motor de calcul.":"Same geometry, reference parameters, same calculation engine.","Clădire evaluată":"Evaluated building","Clădire de referință":"Reference building","Anvelopa clădirii":"Building envelope","Contribuțiile la pierderile prin transmisie, în W/K.":"Contributions to transmission heat loss, in W/K.","Surse de energie":"Energy sources","Energia finală agregată după sursa cumpărată.":"Final energy aggregated by purchased energy source.","Profil lunar":"Monthly profile","Necesar util lunar pentru încălzire și răcire.":"Monthly useful demand for heating and cooling.","Detalii metodologice":"Methodology details","Necesar util anual pentru încălzire":"Annual useful heating demand","Necesar util anual pentru răcire":"Annual useful cooling demand","Model solar":"Solar model","Stație solară Hsol":"Hsol solar source station","corespondent direct":"direct match","stație-sursă coincidentă":"coincident source station","cea mai apropiată":"nearest source","Orientare solară":"Solar orientation","Vitraj solar":"Solar glazing","Umbrire vitraj":"Glazing shading","Fallback aport explicit · Hsol indisponibil":"Explicit-gain fallback · Hsol unavailable","Aport lunar explicit":"Explicit monthly gain","Metodologie":"Methodology","Calculează altă locuință":"Calculate another home","Generează raportul A4":"Generate A4 report","Pereți exteriori":"Exterior walls","Acoperiș / tavan":"Roof / ceiling","Pardoseală spre sol":"Floor to ground","Ferestre":"Windows","Uși exterioare":"Exterior doors","Punți termice liniare":"Linear thermal bridges",
    "Calculator energetic pentru clienții magazinului":"Energy calculator for store customers","Următorul pas":"Next step","Transformă scenariul ales într-o ofertă concretă.":"Turn the selected scenario into a concrete quote.","Rezultatele rămân estimări tehnice; partenerul poate verifica produsul, dimensionarea și condițiile de montaj.":"Results remain technical estimates; the partner can verify the product, sizing and installation conditions.","Cere ofertă pentru scenariul ales":"Request a quote for this scenario","LaCurent Embed":"LaCurent Embed","Calculator energetic integrabil direct în site-ul partenerului.":"An energy calculator embedded directly in the partner website.","Integrare minimă":"Minimal integration","Partenerul adaugă containerul și loader-ul. Înălțimea iframe-ului se adaptează automat.":"The partner adds the container and loader. The iframe height adjusts automatically.","Cererea este pregătită. Verific-o înainte de trimitere.":"The request is ready. Review it before sending.","Cererea a fost copiată.":"The request was copied.","Copiarea automată nu este disponibilă. Textul este selectat.":"Automatic copying is unavailable. The text is selected."
  };
